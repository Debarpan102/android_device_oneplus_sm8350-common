...
TARGET_PREBUILT_DIR := device/oneplus/sm8350-common-kernel
TARGET_KERNEL_SOURCE := $(TARGET_PREBUILT_DIR)/kernel-headers
TARGET_NO_KERNEL_OVERRIDE := true
TARGET_NO_KERNEL := false
BOARD_PREBUILT_DTBIMAGE_DIR := $(TARGET_PREBUILT_DIR)/dts/vendor/oplus/lunaa/
BOARD_PREBUILT_DTBOIMAGE := $(TARGET_PREBUILT_DIR)/dtbo.img
LOCAL_KERNEL :=  $(TARGET_PREBUILT_DIR)/Image
PRODUCT_COPY_FILES += $(LOCAL_KERNEL):kernel

# Kernel modules
KERNEL_MODULE_DIR := $(TARGET_PREBUILT_DIR)
